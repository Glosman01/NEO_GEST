...
-- Schema neogest
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `neogest` DEFAULT CHARACTER SET utf8 ;
USE `neogest` ;

-- -----------------------------------------------------
-- Table `neogest`.`Rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Rol` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Usuario` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Cliente` (
  ...
  CONSTRAINT `fk_Cliente_Usuario1`
    ...
    REFERENCES `neogest`.`Usuario` (`idUsuario` , `Rol_idRol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Empleado` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Carrito` (
  ...
  CONSTRAINT `fk_Carrito_Cliente1`
    ...
    REFERENCES `neogest`.`Cliente` (`idCliente` , `Usuario_idUsuario` , `Usuario_Rol_idRol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Categoria` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Producto` (
  ...
  CONSTRAINT `fk_Producto_Categoria1`
    ...
    REFERENCES `neogest`.`Categoria` (`idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`item_carrito` (
  ...
  CONSTRAINT `fk_item_carrito_Carrito1`
    ...
    REFERENCES `neogest`.`Carrito` (`idCarrito` , `Cliente_idCliente` , `Cliente_Usuario_idUsuario` , `Cliente_Usuario_Rol_idRol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_carrito_Producto1`
    FOREIGN KEY (`Producto_idProducto`)
    REFERENCES `neogest`.`Producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Movimiento_inventario` (
  ...
  CONSTRAINT `fk_Movimiento_inventario_Empleado1`
    ...
    REFERENCES `neogest`.`Empleado` (`idEmpleado` , `Empleadocol` , `Usuario_idUsuario` , `Usuario_Rol_idRol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Pedido` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Detalle_pedido` (
  ...
  CONSTRAINT `fk_Detalle_pedido_Pedido1`
    ...
    REFERENCES `neogest`.`Pedido` (`idPedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Factura` (
...
-- Table `neogest`.`Pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Pago` (
...
-- Table `neogest`.`Envio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Envio` (
  ...
  CONSTRAINT `fk_Envio_Pedido1`
    ...
    REFERENCES `neogest`.`Pedido` (`idPedido` , `Cliente_idCliente` , `Cliente_Usuario_idUsuario` , `Cliente_Usuario_Rol_idRol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neogest`.`Devolucion` (
